...
<div class="niwdoawi_top mw_1180">
    <div class="header w1190 clearfix">
        ...
        <div class="fr login clearfix">
            ...
            @else
                <div class="login_bt"><a class="fff" title="我的投资" rel="nofollow" href="mybid">您好！{{Auth::user()->name}}</a><a class="fff" title="退出" rel="nofollow" href="logout">退出登录</a></div>
            @endif
            <dl>
                    ...
                    <div class="pro_bor">
                        <ul class="clearfix pro_list_box">
                            ...
                            <li class="w3">
                                ...
                                <p class="fc_6 airal fs_18">{{$pro->recive/100}}</p>
                            </li>
                            <li class="w4">
                                <span class="b_jingdu b_jd{{sprintf('%d',($pro->recive/$pro->money)*100)}}">{{sprintf('%.2f',($pro->recive/$pro->money)*100)}}%</span>
                            </li>
                            <li class="w5">
